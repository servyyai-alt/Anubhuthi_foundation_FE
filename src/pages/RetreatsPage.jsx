...
import spiritualNatureCamps from "../assets/spiritual-nature-camps.png";
import meditationJourneys from "../assets/meditation-journeys.png";
import consciousLivingPrograms from "../assets/conscious-living-programs.png";
import internationalAwarenessTours from "../assets/international-awareness-tours.png";
...
export default function RetreatsPage() {
  ...
  const retreats = [
    ...
    },
    {
      ...
      image: spiritualNatureCamps,
    },
    {
      title: "Meditation Journeys",
      image: meditationJourneys,
    },
    {
      title: "Conscious Living Programs",
      image: consciousLivingPrograms,
    },
    {
      title: "International Awareness Tours",
      image: internationalAwarenessTours,
    },
  ];
  ...
  return (
    <section className="bg-[#f8f2e8]">
      ...
      <div
        className="bg-cover bg-center pt-28 pb-20"
        style={{
          backgroundImage: `url(${bg})`,
        }}
      >
        <div className="max-w-7xl mx-auto px-6 text-center text-white">
          <nav className="text-sm text-[#12264D] mb-6 flex items-center gap-1.5 font-sans justify-start">
            <Link to="/" className="hover:text-[#D8A24A] transition-colors">
              Home
            </Link>
            <span>&lt;</span>
            <span className="text-[#12264D]/80">Retreats</span>
          </nav>
